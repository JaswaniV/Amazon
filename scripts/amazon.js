...
loadProducts(renderProductGrid); //ye kaam nhi krega because ye http request jo jaaegi usko travel mein time lagega aur ye jb tk next lin ko execute krne lag jaaega aur tb tk products load nhi hue  honge therfore the page will look empty , So what we will have to do is we need to wait for this to finish 
//So one way is copy the code below and put it in the products,js just after the evenListener There fore we will create a function
