...
describe('Test suite: renderOrderSummary', () =>{
    ...
    beforeEach( () => {
        ...
        /*If the test stops working try putting the line written in this comment after the container with class js-order summart
        <div class="js-checkout-total-quantity"></div>
         */
        
        /*
        Since we have the div with class named js-order-summary , So when we'll call the renderOrderSummary function it will put the html inside the div with class js-order-summary  
        */
        ...
        loadFromStorage();
        /*
        We are calling the loadFromStorage fucntion so that lS.getItem runs and gets the prouct which we added while mockiong only and not any other default value in the cart 
        */
